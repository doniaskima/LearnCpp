...
main(){
   int a=10,b=35; // 4 bytes
    ...
    bool b1 = true; //Boolean is true or false .FAAAAAALSE IS ALWAYS ZERO , EVERY OTHER NUMBER IS TRUE
    cout <<b1<<endl;
    b1 = 1515;
    cout <<b1<<endl;
    b1 = 445;
    ...
    //Positive Numbers or unsigned .Increase the positive range !
    unsigned short int u1 = 6042;
    cout <<u1<<endl;

    const string myname = "Donia";
    cout <<myname<<endl;
}